...
@Component({
  selector: 'app-audio-call-server',
  templateUrl: './audio-call-server.component.html',
  styleUrls: ['./audio-call-server.component.scss'],
  encapsulation: ViewEncapsulation.None,
})
export class AudioCallServerComponent implements OnInit {
  ...
  // show pie charts
  showPieCharts() {
    this.systemServerSvc.getServerData(typesOfServer.audioCallServer).subscribe((res: any) => {
      if (res.data) {
  ...
  // Get Band width
  getBandWidth() {
    this.systemServerSvc.getServerBandWidth(typesOfServer.audioCallServer).subscribe((res: any) => {
      if (res.data) {
